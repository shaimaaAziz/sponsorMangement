...
$templateCache.put('angularUtils.directives.dirPagination.template',
    ...
    '  border: 1px solid #ddd;" ng-if="boundaryLinks"' +
    ...
    '  text-decoration: none;\n' +
    '  transition: background-color .3s;\n' +
    '  border: 1px solid #ddd;" ng-if="directionLinks"' +
    ' ng-class="{ disabled : pagination.current == 1 }">' +
    ...
    'ng-class="{ active : pagination.current == pageNumber, disabled : pageNumber == \'...\' || ( ! autoHide && pages.length === 1 ) }"><a href="" ng-click="setCurrent(pageNumber)">' +
    '{{ pageNumber }}</a></li>' +
    '<li style="color: black;\n' +
    '  float: left;\n' +
    '  padding: 8px 16px;\n' +
    ...
    '  text-decoration: none;\n' +
    '  transition: background-color .3s;\n' +
    '  border: 1px solid #ddd;" ng-if="boundaryLinks"  ng-class="{ disabled : pagination.current == pagination.last }"><a href="" ng-click="setCurrent(pagination.last)">&raquo;</a></li></ul>');
}
